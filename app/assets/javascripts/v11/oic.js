accessibleAutocomplete.enhanceSelectElement({
  selectElement: document.querySelector('#oic-rank')
})
...
function validateForm() {
    ...
    $('#oic-forename').removeClass('govuk-input--error');
    ...
    var oicForename = document.forms["myForm"]["oicForename"].value;
    ...
    if (oicSurname == "" || oicSurname == null || oicSurname == "" || oicSurname == null) {
      ...
      if (oicForename == "" || oicForename == null) {
        ...
        // Error message
        $('#oic-forename-label').append('<p id="error-message-2" class="govuk-error-message"></p>');
        $('#error-message-2').html('<span id="error-2"><span class="govuk-visually-hidden">Error:</span> Enter the officer in charge\'s forename</span>');
  
        // Error summary
        $('#error-list-item-2').html('<a href="#error-2">Enter the officer in charge\'s forename</a>');
      }
