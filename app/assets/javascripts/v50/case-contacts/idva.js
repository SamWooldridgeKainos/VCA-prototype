// Validation for IDVA contact form
function validateForm() {
  ...
  $('#idva-name').removeClass('govuk-input--error');
  $('#idva-email').removeClass('govuk-input--error');
  $('#idva-telephone').removeClass('govuk-input--error');
  $('#error-message-name').remove();
  $('#error-message-email').remove();
  $('#error-message-telephone').remove();
  $('#error-summary').remove();

  var name = document.forms['myForm']['idvaName'].value.trim();
  var email = document.forms['myForm']['idvaEmailAddress'].value.trim();
  var telephone = document.forms['myForm']['idvaPhoneNumber'].value.trim();
  ...
  if (!name) {
    hasErrors = true;
    errorItems += '<li><a href="#idva-name">Enter the name</a></li>';
    $('#error-form-group-name').addClass('govuk-form-group--error');
    $('#idva-name').addClass('govuk-input--error').before(
  ...
  if (!email) {
    hasErrors = true;
    errorItems += '<li><a href="#idva-email">Enter an email address</a></li>';
    $('#error-form-group-email').addClass('govuk-form-group--error');
    $('#idva-email').addClass('govuk-input--error').before(
  ...
  if (!telephone) {
    hasErrors = true;
    errorItems += '<li><a href="#idva-telephone">Enter a telephone number</a></li>';
    $('#error-form-group-telephone').addClass('govuk-form-group--error');
    $('#idva-telephone').addClass('govuk-input--error').before(
