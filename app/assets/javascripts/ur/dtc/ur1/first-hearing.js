...
function validateForm() {
    ...
    if (firstHearingLocation == "" || firstHearingLocation == null || firstHearingDate == "" || firstHearingDate == null) {
      ...
      if (firstHearingDate == "" || firstHearingDate == null) {
        ...
        $('#error-message-2').html('<span id="error-2"><span class="govuk-visually-hidden">Error:</span> Enter the date of the first hearing</span>');
  
        // Error summary
        $('#error-list-item-2').html('<a href="#error-2">Enter the date of the first hearing</a>');
      }
