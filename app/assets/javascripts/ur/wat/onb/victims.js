...
function renderChips() {
    ...
    // Render caseworker chips
    renderChipCategory(ownerCheckboxes, 'Caseworker');
...
// Initialize accessible-autocomplete for Caseworker (Owner) filter
...
var container = document.querySelector('#caseworker-autocomplete');
var ownerCheckboxesContainer = document.getElementById('owner-checkboxes-container');
var ownerCheckboxes = document.querySelectorAll('.owner-checkbox');

if (!container) {
    console.error('Caseworker autocomplete container not found');
    return;
}
...
accessibleAutocomplete({
    element: container,
    id: 'caseworker-autocomplete-input',
    source: sourceFunction,
    showAllValues: true,
    minLength: 0,
    confirmOnBlur: true,
