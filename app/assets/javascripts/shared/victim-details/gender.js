...
function validateForm() {
  ...
  var radioChecked = $('[name=victimGender]').is(':checked');

  if (radioChecked) return true;

  var listHtml = '<li><a href="#error-message-radio">Select a gender</a></li>';
  ...
  $('#radio-group').before('<p class="govuk-error-message" id="error-message-radio"><span class="govuk-visually-hidden">Error:</span> Select a gender</p>');
