...
function validateForm() {
  ...
  var radioChecked = $('[name=victimReligion]').is(':checked');

  if (radioChecked) return true;

  var listHtml = '<li><a href="#error-message-radio">Select a religion or belief</a></li>';
  ...
  $('#radio-group').before('<p class="govuk-error-message" id="error-message-radio"><span class="govuk-visually-hidden">Error:</span> Select a religion or belief</p>');
