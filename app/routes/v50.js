...
module.exports = router => {
    ...
    router.post('/v50/pcd/follow-up/telephone-call-answer', function(request, response) {
        ...
        response.redirect("/v50/pcd/follow-up/call-logged")
    })
    ...
    router.post('/v50/pcd/follow-up/not-contacted-reason-answer', function(request, response) {
        ...
        response.redirect("/v50/pcd/follow-up/not-contacted-logged")
    })
